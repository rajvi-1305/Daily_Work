...
namespace Mission.Entities.Context
{
    public class MissionDbContext(DbContextOptions<MissionDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<MissionFavourites>()
                .HasKey(mf => new { mf.UserId, mf.MissionId });

            builder.Entity<MissionRating>()
                .HasKey(r => new { r.UserId, r.MissionId });

            builder.Entity<Story>()
                .HasKey(s => new { s.UserId, s.Title });

            builder.Entity<VolunteeringGoals>()
                .HasKey(g => new { g.UserId, g.GoalType });
            builder.Entity<VolunteeringHours>()
                .HasKey(v => new { v.UserId, v.DateVolunteered });
