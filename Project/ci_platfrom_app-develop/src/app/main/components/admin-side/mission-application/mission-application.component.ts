...
export class MissionApplicationComponent implements OnInit, OnDestroy {
  ...
  fetchMissionApplicationList() {
    const missionApplicationSubscription = this._service
  ...
  approveMissionApplication(value: any) {
    const missionApplicationSubscription = this._service
      .missionApplicationApprove(value)
      .subscribe(
        (data: any) => {
          if (data.result == 1) {
            this._toast.success({
  ...
  deleteMissionApplication(value: any) {
    const missionApplicationDeleteSubscription = this._service
      .missionApplicationDelete(value)
      .subscribe(
        (data: any) => {
          if (data.result == 1) {
            this._toast.success({
